"""
Usage:
python dataset.py --command create_dataset --input data/train-v1.1.json --output data/train.bin,data/validation.bin --split 0.8,0.2
python dataset.py --command create_vocab --input data/train-v1.1.json --output data/vocab
"""
import glob
import json
import struct
